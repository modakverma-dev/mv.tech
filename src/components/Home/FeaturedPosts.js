      ...
      <section className="md:max-w-[1000px] w-full mt-10 px-5 flex flex-col items-center justify-center relative">
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-1 md:gap-6 mt-8 h-[90vh] w-full">
          <article
            ...
            className="col-span-1 row-span-2 rounded-2xl border-2 border-slate-500/70 dark:bg-black bg-white overflow-hidden w-full h-full "
          >
            <BlogLayoutOne count={count} blog={sortedBlogs[count]} />
          </article>
          <article className="col-span-1 row-span-1 w-full h-full rounded-2xl border-2 border-slate-500/70 overflow-hidden  dark:bg-black bg-white ">
            <BlogLayoutOne
              count={count + 1}
