...
const HomeCoverSection = ({ blogs }) => {
  ...
  return (
    <div className="w-full inline-block px-8 pt-10">
      <article className="flex flex-col items-start justify-end  relative h-[85vh]">
        <div className="absolute top-0 left-0 bottom-0 right-0 h-full bg-gradient-to-b from-transparent from-0% to-dark/80 z-0 rounded-xl" />
        <Image
